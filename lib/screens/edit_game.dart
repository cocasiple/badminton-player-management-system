...
class _EditGameScreenState extends State<EditGameScreen> {
  ...
  void _save() {
    if (_formKey.currentState?.validate() ?? false) {
      ...
      Navigator.pop(context, {'action': 'update', 'game': updatedGame});
    }
  }
  ...
  void _delete() async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text('Are you sure you want to delete "${widget.game.displayTitle}"?'),
          actions: [
            TextButton(
    ...
    if (confirmed == true) {
      Navigator.pop(context, {'action': 'delete', 'id': widget.game.id});
    }
  }
